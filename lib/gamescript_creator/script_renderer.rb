...
require_relative 'html_helpers/tags'
require_relative 'html_helpers/utils'
...
module GamescriptCreator
  ...
  class FormattedTextRenderer
    ...
    label = root.label
      ...
      elsif root.is_node_of_type?(GamescriptCreator::NODE_WRAP)
      ...
      elsif root.is_node_of_type?(GamescriptCreator::NODE_PLAIN_TEXT)
        writer << root.content
      else
