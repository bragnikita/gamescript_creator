...
include GamescriptCreator::BasicScriptModel
include GamescriptCreator

RSpec.describe GamescriptCreator::ScriptParser do

  describe "correct script" do
    let(:reader) do
      GamescriptCreator::FileLineReader.new(File.expand_path('./correct.txt', __dir__))
    end
    let(:parser) do
      GamescriptCreator::ScriptParser.new(reader)
    end
...
RSpec.describe GamescriptCreator::FormattedLineParser do
...
RSpec.describe GamescriptCreator::ScriptModelBuilder do
  let(:basic_model) do
    reader = GamescriptCreator::FileLineReader.new(File.expand_path('./correct.txt', __dir__))
    parser = GamescriptCreator::ScriptParser.new(reader)
    parser.process
  end
